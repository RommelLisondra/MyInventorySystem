...
interface Props {
  ...
  onReload: () => void;
  onUpdate: (employee: EmployeeChecker) => void;
  onSearch?: (query: string) => void;
}

const CheckerList: React.FC<Props> = ({employees,onDelete,onEdit,onReload,onSearch,}) => {
      ...
      <div className="page-header">
        ...
        <div className="page-btn d-flex gap-2">
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              navigate(ROUTES.EMPLOYEECHECKER_CREATE); 
            }}
          >
