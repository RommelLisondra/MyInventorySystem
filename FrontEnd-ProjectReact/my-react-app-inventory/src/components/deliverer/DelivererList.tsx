...
interface Props {
  ...
  onReload: () => void;
  onUpdate: (employee: EmployeeDelivered) => void;
  onSearch?: (query: string) => void;
}

const DelivererList: React.FC<Props> = ({ employees, onDelete, onEdit, onReload, onSearch, }) => {
    ...
    <div className="content">
      ...
      <div className="page-header">
        <div className="page-title">
          <h4>Deliverer List</h4>
          <h6>Manage your Deliverer</h6>
        </div>
        <div className="page-btn d-flex gap-2">
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              navigate(ROUTES.EMPLOYEEDELIVERER_CREATE);
            }}
          >
