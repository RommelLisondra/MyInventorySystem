...
interface Props {
  ...
  onReload: () => void;
  onUpdate: (employee: Supplier) => void;
  onSearch?: (query: string) => void;
}

const SupplierList: React.FC<Props> = ({suppliers,onDelete,onEdit,onReload,onSearch,}) => {
      ...
      <div className="page-header">
        ...
        <div className="page-btn d-flex gap-2">
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              navigate(ROUTES.SUPPLIER_CREATE);
            }}
          >
