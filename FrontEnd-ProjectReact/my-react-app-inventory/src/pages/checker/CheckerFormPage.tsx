...
const CheckerFormPage: React.FC = () => {
    const { id } = useParams();
    const navigate = useNavigate();
    const { employeeCheckers, addNewEmployeeChecker, updateEmployeeChecker } = useEmployeeChecker();

    const existing = employeeCheckers.find((e) => e.id === Number(id));

    const [form, setForm] = useState<EmployeeChecker>(
        existing || {
            id: 0,
            empIdno: "",
    ...
    const handleChange = (field: keyof EmployeeChecker, value: any) => {
    ...
    const handleSubmit = () => {
        ...
        if (id) updateEmployeeChecker(form);
        else addNewEmployeeChecker(form);
        
        navigate(ROUTES.EMPLOYEECHECKER_LIST);
    };
        ...
        <div className="cardhead">
            <div className="content container-fluid">
                <div className="page-header">
                    <div className="row">
                        <div className="col">
                            <h3 className="page-title">{id ? "Edit Checker" : "Create Checker"}</h3>
                            <ul className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active">
                                    {id ? "Edit Checker" : "Create Checker"}
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-12">
                        <div className="card">
                            <div className="card-header">
                                <h5 className="card-title">Checker Details</h5>
                            </div>
...
export default CheckerFormPage;
