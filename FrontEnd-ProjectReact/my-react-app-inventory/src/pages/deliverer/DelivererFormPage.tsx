...
const DelivererFormPage: React.FC = () => {
    const { id } = useParams();
    const navigate = useNavigate();
    const { employeeDelivered, addNewEmployeeDelivered, updateEmployeeDelivered } = useEmployeeDelivered();

    const existing = employeeDelivered.find((e) => e.id === Number(id));

    const [form, setForm] = useState<EmployeeDelivered>(
        existing || {
            id: 0,
            empIdno: "",
    ...
    const handleChange = (field: keyof EmployeeDelivered, value: any) => {
    ...
    const handleSubmit = () => {
        ...
        if (id) updateEmployeeDelivered(form);
        else addNewEmployeeDelivered(form);
        
        navigate(ROUTES.EMPLOYEEDELIVERER_LIST);
    };
    ...
    return (
        ...
        <div className="content container-fluid">
            ...
            <div className="row">
                <div className="col">
                    <h3 className="page-title">{id ? "Edit Deliverer" : "Create Deliverer"}</h3>
                    ...
                    <li className="breadcrumb-item active">
                        {id ? "Edit Deliverer" : "Create Deliverer"}
                    </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="col-lg-12">
                ...
                <div className="card-header">
                    <h5 className="card-title">Deliverer Details</h5>
                </div>
                <div className="card-body">
                    ...
                    <div className="form-group row mt-3">
                        ...
                        <button
                            ...
                            type="button"
                            onClick={() => navigate(ROUTES.EMPLOYEEDELIVERER_LIST)}
                        >
                            Cancel
                        </button>
                        </div>
...
export default DelivererFormPage;
