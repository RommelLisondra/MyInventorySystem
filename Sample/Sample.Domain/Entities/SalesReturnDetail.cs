...
{
    public class SalesReturnDetail : EntityBase, IAggregateRoot
    {
        public virtual int id { get; set; }
        public virtual string Srdno { get; set; } = null!;
        ...
        public virtual SalesReturnMaster SrdnoNavigation { get; set; } = null!;
